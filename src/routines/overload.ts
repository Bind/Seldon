...
import { ChainedMoved } from "../subroutines/chainedMove.js";
import { DelayedMove } from "../subroutines/delayedMove";
    ...
    const addedEnergy = juice.reduce(
      (acc, a) =>
        ...
        df.getEnergyArrivingForMove(
          a.payload.srcId,
          srcId,
          df.getDist(a.payload.srcId, srcId),
          75
        ),
      0
    );
